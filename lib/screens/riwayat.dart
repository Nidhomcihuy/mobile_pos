        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _detailRow('Metode', (data['payment_method'] ?? '-').toString().toUpperCase()),
              ...
              ...items.map((item) {
                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(child: Text('${i['product_name']} x${i['quantity']}')),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Color(0xFFCE8947)),
                  ),
                ],
              ),
            ],
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('Riwayat Transaksi', style: TextStyle(fontSize: r.font(22), fontWeight: FontWeight.w800, color: const Color(0xFF555555), fontFamily: 'Inter')),
          ),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: r.space(24)),
            child: Column(
              children: [
                _buildStatCard('TOTAL PEMASUKAN HARI INI', _formatPrice(totalPemasukanHariIni), 'Berdasarkan data hari ini', r, isHighlight: true),
                SizedBox(height: r.space(12)),
                Row(
                  children: [
                    _buildStatCard('Transaksi', '${todayTx.length}', 'Hari Ini', r),
          ...
          Expanded(
            child: Container(
              ...
              child: _isLoading
                  ? const Center(child: CircularProgressIndicator(color: Color(0xFFBDB76B)))
                  : _errorMessage != null
                              ...
                              return SingleChildScrollView(
                                child: SingleChildScrollView(
                                  ...
                                  child: ConstrainedBox(
                                    ...
                                    child: DataTable(
                                      headingRowColor: WidgetStateProperty.all(const Color(0xFFBDB76B).withOpacity(0.2)),
                                      ...
                                      rows: _transactions.map((data) {
                                        ...
                                        return DataRow(cells: [
                                          DataCell(Text((data['invoice_number'] ?? '#${data['id']}').toString(), style: const TextStyle(fontSize: 12))),
                                          DataCell(Text(timePart)),
                                          DataCell(Text(method, style: TextStyle(color: method == 'QRIS' ? Colors.blue : Colors.green, fontWeight: FontWeight.bold))),
                                          DataCell(Text(_formatPrice((data['total_amount'] as num).toInt()), style: const TextStyle(fontWeight: FontWeight.bold))),
                                          DataCell(IconButton(icon: const Icon(Icons.visibility, color: Color(0xFFCE8947)), onPressed: () => _showTransactionDetail(context, data, r))),
                                        ]);
                                      }).toList(),
                                    ),
                                  ),
